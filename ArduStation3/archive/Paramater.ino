  ...
  switch(droneType) {
    ...
    case MAV_GENERIC: { // MAV_QUADROTOR
      ...
      switch (index) {
        ...
        case 21: { strcpy_P(buffer, PSTR("CAM_P_G")); break; }
        case 22: { strcpy_P(buffer, PSTR("CAM_R_G")); break; }
        case 23: { strcpy_P(buffer, PSTR("WP_SPEED_MAX")); break; }
        ...
        case 31: { strcpy_P(buffer, PSTR("NAV_LON_IMAX_")); break; }
        case 32: { strcpy_P(buffer, PSTR("THR_RATE_P")); break; }
        case 33: { strcpy_P(buffer, PSTR("THR_RATE_I")); break; }
        case 34: { strcpy_P(buffer, PSTR("THR_RATE_D")); break; }
        case 35: { strcpy_P(buffer, PSTR("THR_RATE_IMAX")); break; }
        case 36: { strcpy_P(buffer, PSTR("HLD_LAT_P")); break; }
        case 37: { strcpy_P(buffer, PSTR("HLD_LAT_I")); break; }
        case 38: { strcpy_P(buffer, PSTR("HLD_LAT_IMAX")); break; }
        case 39: { strcpy_P(buffer, PSTR("HLD_LON_P")); break; }
        case 40: { strcpy_P(buffer, PSTR("HLD_LON_I")); break; }
        case 41: { strcpy_P(buffer, PSTR("HLD_LON_IMAX")); break; }
        case 42: { strcpy_P(buffer, PSTR("LOITER_LAT_P")); break; }
        case 43: { strcpy_P(buffer, PSTR("LOITER_LAT_I")); break; }
        case 44: { strcpy_P(buffer, PSTR("LOITER_LAT_D")); break; }
        case 45: { strcpy_P(buffer, PSTR("LOITER_LAT_IMAX")); break; }
        case 46: { strcpy_P(buffer, PSTR("LOITER_LON_P")); break; }
        case 47: { strcpy_P(buffer, PSTR("LOITER_LON_I")); break; }
        case 48: { strcpy_P(buffer, PSTR("LOITER_LON_D")); break; }
        case 49: { strcpy_P(buffer, PSTR("LOITER_LON_IMAX")); break; }
        case 50: { strcpy_P(buffer, PSTR("STAB_D")); break; }
...
//    Serial.print(paramsRecv+1);
//    Serial.print(" of ");
//    Serial.print(TOTAL_PARAMS);
//  }
...
//    Serial.println(editParm.key);
//  else
//  {
//    for (int i=0; i<12; i++)
//      lcd.print(editParm.key[i]);
//  }
//  Serial.println(editParm.value);
}
...
//  if (redraw == 1)
//  {
//    Serial.println("Sending new value...");
//    redraw = 0;
//  }
  if (waitingAck == 0)
  {
