...
{              
               ...
               myGLCD.setColor(255, 255, 255);
               myGLCD.setBackColor(255, 0, 0);
               myGLCD.print("Tune Loiter", CENTER, 1);
               myGLCD.setFont(BigFont);
               myGLCD.setBackColor(0, 0, 128);
...
{              
  if(pSend)
  {
    ...
    cmdSetParm((128+x), value);
    cmdSetParm((128+x+4), value);
    //cmdRequestParm();
    ...
    if((tuneP == 0.0) && (tuneI == 0.0) && (tuneD == 0.0) && (tuneIMax == 0.0))
      {
        for(int x; x < 4; x++)
        {
          value = EEPROM_readDouble((128 + x)*4);
...
{              
               ...
               myGLCD.setColor(255, 255, 255);
               myGLCD.setBackColor(255, 0, 0);
               myGLCD.print("Tune Nav", CENTER, 1);
               myGLCD.setFont(BigFont);
               myGLCD.setBackColor(0, 0, 128);
...
{              
  if(pSend)
  {
    ...
    cmdSetParm((136+x), value);
    cmdSetParm((136+x+4), value);
    //cmdRequestParm();
    ...
    if((tuneP == 0.0) && (tuneI == 0.0) && (tuneD == 0.0) && (tuneIMax == 0.0))
      {
        for(int x; x < 4; x++)
        {
          value = EEPROM_readDouble((136 + x)*4);
      ...
      {
      /*
      NOTE: Add Green/Red bar next to text to signify saved & unsaved data
            fix the problem where tuneIMax is assigned to all values
      */  
          int x = ley;
          switch(x)
            {
